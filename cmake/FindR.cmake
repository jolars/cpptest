# FindR.cmkae Make sure find package macros are included
...
if(R_EXECUTABLE)
  ...
  set(R_HOME
      ${R_BASE_DIR}
      CACHE PATH "R home directory obtained from R RHOME")
...
set(REQUIRED_R_VARIABLES R_EXECUTABLE)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
  R
  REQUIRED_VARS ${REQUIRED_R_VARIABLES}
